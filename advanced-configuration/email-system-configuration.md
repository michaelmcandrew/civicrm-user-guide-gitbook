...
ciki.([http://wiki.civicrm.org/confluence/display/CRMDOC/CiviMail+Installation](http://wiki.civicrm.org/confluence/display/CRMDOC/CiviMail+Installation)).
...
The "Received: from" header should correspond to your mail server and be
...
The "Received-SPF" header should list "pass" or "neutral".  Sender
